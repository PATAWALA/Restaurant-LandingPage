              ...
              >
                <div className="relative inline-block">
                  ...
                  <div className="relative w-64 h-64 sm:w-80 sm:h-80 md:w-96 md:h-96 bg-gray-200 rounded-2xl overflow-hidden shadow-2xl">
                    <img
                      src="/images/moi.jpeg"
                      alt="Abdoulaye - Expert sites web restaurants"
            ...
            <div>
              ...
              <ul className="space-y-3 text-gray-400">
                <li className="flex items-center gap-2">
                  <span>🌐</span> Sites web pour restaurants
                </li>
                <li className="flex items-center gap-2">
                  <span>📅</span> Système de réservation en ligne
                </li>
                <li className="flex items-center gap-2">
                  <span>🍽️</span> Menu digital avec photos
                </li>
                <li className="flex items-center gap-2">
                  <span>🗺️</span> Optimisation Google Maps
                </li>
                <li className="flex items-center gap-2">
                  <span>⭐</span> Collecte d'avis Google
                </li>
                <li className="flex items-center gap-2">
                  <span>💬</span> WhatsApp Business intégré
                </li>
              </ul>
            </div>
            ...
            <div>
              ...
              <div className="flex space-x-4">
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="w-12 h-12 bg-green-500 hover:bg-green-600 rounded-full flex items-center justify-center transition-all hover:scale-110 shadow-lg"
                  title="WhatsApp"
                >
                  <svg
