      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16 md:h-20">
          ...
          <div className="hidden md:flex items-center space-x-6">
            <a href="#problems" className="text-gray-600 hover:text-red-600 transition-colors text-sm font-medium">Problèmes</a>
...
function Problems() {
  const problems = [
    { icon: "👻", title: "Vous êtes un fantôme sur Google", desc: "Quand un client tape 'meilleur restaurant [votre ville]', vous n'apparaissez même pas. Il clique sur le premier résultat : votre concurrent. Félicitations, vous venez de lui offrir un client." },
    { icon: "📞", title: "Le téléphone qui tue votre service", desc: "Vous êtes en plein coup de feu, le téléphone sonne. Vous répondez et perdez 5 minutes à expliquer le menu. Pendant ce temps, 3 plats refroidissent en cuisine. La réservation en ligne ? Vos concurrents l'ont déjà." },
    { icon: "💸", title: "Des tables vides = de l'argent brûlé", desc: "Chaque table vide ce soir, c'est 50€ à 150€ qui ne rentrent pas dans votre caisse. Multiplié par 30 soirs. Multiplié par 12 mois. Vous voulez vraiment faire le calcul ou vous préférez continuer à perdre de l'argent sans savoir combien ?" },
    { icon: "🍽️", title: "Votre menu est invisible", desc: "Aujourd'hui, un client veut voir vos plats AVANT de réserver. Pas de photos en ligne ? Pas de menu visible ? Il passe au restaurant suivant. C'est aussi simple que ça." },
    { icon: "⭐", title: "Zéro avis, zéro confiance", desc: "89% des clients lisent les avis avant de choisir un restaurant. Sans présence en ligne, vous ne collectez même pas d'avis. Vos concurrents affichent leurs 4.8 étoiles. Vous affichez du vide." },
    { icon: "🏃", title: "Vos concurrents vous remercient", desc: "Chaque jour où vous restez invisible en ligne, vous faites un cadeau à vos concurrents. Ils ne vous remercieront jamais en face, mais leurs comptes bancaires vous disent merci." },
  ];
      ...
      <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <h2 className="text-3xl md:text-5xl font-extrabold text-gray-900 mb-4">
            Voici ce qui arrive <span className="text-red-600">en ce moment même</span>{" "}dans votre restaurant
          </h2>
    ...
    <section className="relative w-full py-16 sm:py-24 bg-gradient-to-br from-gray-100 to-red-50">
      <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <motion.div 
          ...
          viewport={{ once: true, margin: "-100px" }}
        >
          <span className="inline-block bg-orange-100 text-orange-700 px-4 py-1.5 rounded-full text-sm font-semibold mb-4">⚖️ Le choix est simple</span>
          <h2 className="text-3xl md:text-5xl font-extrabold text-gray-900 mb-4">
        ...
        <div className="w-full grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12">
          ...
          >
            ...
            <div className="p-6 sm:p-8 space-y-3 sm:space-y-4">
              {["Invisible sur Google", "Réservations chaotiques", "Aucune preuve sociale", "Des tables vides", "Image dépassée", "Vous bossez plus pour gagner moins"].map((item, i) => (
            ...
            <div className="bg-red-50 px-8 py-4 text-center">
              <p className="text-red-700 font-bold">Résultat : de l'argent perdu, tous les jours.</p>
            </div>
          </motion.div>
          ...
          <motion.div 
            ...
            className="w-full bg-white rounded-2xl shadow-xl overflow-hidden h-full"
          >
            <div className="bg-gradient-to-r from-red-600 to-orange-500 text-white text-center py-4 font-bold text-lg">✅ Votre restaurant DANS 2 SEMAINES</div>
            <div className="p-6 sm:p-8 space-y-3 sm:space-y-4">
              {["Visible sur Google 24h/24", "Réservations automatiques", "Menu digital avec photos", "Tables pleines", "Image moderne et pro", "Vous bossez mieux, pas plus"].map((item, i) => (
                <div key={i} className="flex items-start space-x-3">
            ...
            <div className="bg-green-50 px-8 py-4 text-center">
              <p className="text-green-700 font-bold">Résultat : plus de clients, moins de stress, plus de revenus.</p>
            </div>
          </motion.div>
        </div>
...
function Benefits() {
  const benefits = [
    { icon: "👁️", title: "Visible sur Google en 1ère page", desc: "Quand quelqu'un tape 'restaurant [votre ville]', c'est VOUS qui apparaissez en premier. Pas votre concurrent. Fin du fantôme." },
    { icon: "📅", title: "Réservations 24h/24 sans lever le petit doigt", desc: "Les clients réservent à 23h, pendant que vous dormez. Vous vous réveillez avec des tables remplies. Le rêve." },
    { icon: "🍽️", title: "Menu digital qui donne faim", desc: "Photos professionnelles de vos plats. Descriptions qui mettent l'eau à la bouche. Les clients réservent avant même d'avoir fini de scroller." },
    { icon: "⭐", title: "Avis Google qui rassurent", desc: "Quand un nouveau client hésite, il voit vos 4.8 étoiles et les commentaires élogieux. Sa décision est prise en 3 secondes." },
    { icon: "📱", title: "100% optimisé pour téléphone", desc: "80% de vos clients réservent depuis leur smartphone. Votre site sera parfait sur tous les écrans. Zéro friction, zéro abandon." },
    { icon: "🗺️", title: "Google Maps qui vous envoie des clients", desc: "Horaires, menu, photos, bouton 'Itinéraire' : tout est là. Le touriste qui passe dans votre rue vous trouve en un clic." },
    { icon: "💬", title: "WhatsApp intégré pour les urgences", desc: "Un client veut une table pour 10 personnes ce soir ? Il vous écrit directement. Vous répondez en 30 secondes. Table vendue." },
    { icon: "📊", title: "Vous voyez ENFIN ce qui marche", desc: "Combien de visiteurs ? Combien de réservations ? Quel plat attire le plus ? Vous pilotez votre restaurant avec des vrais chiffres, pas à l'aveugle." },
  ];
    ...
    <section id="benefits" className="py-24 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <motion.div 
          ...
          viewport={{ once: true }}
        >
          <span className="inline-block bg-green-100 text-green-700 px-4 py-1.5 rounded-full text-sm font-semibold mb-4">🎯 Ce que vous allez VRAIMENT gagner</span>
          <h2 className="text-3xl md:text-5xl font-extrabold text-gray-900 mb-4">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">Chaque bénéfice ci-dessous = plus d'argent dans votre caisse. Point.</p>
        </motion.div>
    ...
    <section id="opportunities" className="py-24 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <motion.div 
          ...
          viewport={{ once: true }}
        >
          <span className="inline-block bg-purple-100 text-purple-700 px-4 py-1.5 rounded-full text-sm font-semibold mb-4">💸 L'addition qui fait mal</span>
          <h2 className="text-3xl md:text-5xl font-extrabold text-gray-900 mb-4">
            Voici l'argent que vous{" "}
            <span className="text-red-600">offrez à vos concurrents</span><br />
            chaque mois sans le savoir
          </h2>
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">On arrête de se mentir. Voici les vrais chiffres de ce que l'invisibilité vous coûte.</p>
        </motion.div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          >
            ...
            <div className="mt-4 bg-red-200/50 rounded-lg p-3 relative">
              <p className="text-sm font-semibold text-red-800">Soit {Math.round(config.stats.clientsLost / 30)} clients par jour qui passent la porte d'un autre restaurant.</p>
            </div>
          </motion.div>
          ...
          >
            ...
            <div className="text-xl font-bold text-gray-900 mb-2 relative">Revenus perdus</div>
            <p className="text-gray-600 relative">Estimation basse de l'argent qui ne rentre pas dans votre caisse chaque mois.</p>
            <div className="mt-4 bg-purple-200/50 rounded-lg p-3 relative">
              <p className="text-sm font-semibold text-purple-800">De quoi payer le loyer, les charges ET vous verser un salaire.</p>
            </div>
          </motion.div>
        </div>
        ...
        >
          ...
          <p className="text-xl md:text-2xl font-bold mb-2">C'est ce que l'invisibilité vous coûte cette année.</p>
          ...
          <div className="mt-6 inline-block bg-white/20 backdrop-blur-sm rounded-xl px-6 py-3">
            <p className="text-white font-semibold text-lg">Arrêtez de financer le restaurant d'à côté.</p>
          </div>
        </motion.div>
    ...
    <section className="py-24 bg-gradient-to-br from-gray-100 to-red-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <motion.div 
          ...
          viewport={{ once: true }}
        >
          <span className="inline-block bg-yellow-100 text-yellow-700 px-4 py-1.5 rounded-full text-sm font-semibold mb-4">⭐ Ils l'ont fait. Ils ne regrettent pas.</span>
          <h2 className="text-3xl md:text-5xl font-extrabold text-gray-900 mb-4">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="border-t border-gray-800 pt-8">
          ...
          <p className="text-gray-600 text-xs mt-2 text-center italic">
            Fait avec ❤️ pour les restaurateurs qui en ont marre de perdre de l'argent.
          </p>
        </div>
      </div>
    </footer>
